...
`
	...
	expected := &Commit{
		...
		Assignee: assignee.Assignee{Name: "John Doe", Email: "john@example.com"},
...
`
	...
	expected := &Commit{
		...
		Assignee: assignee.Assignee{Name: "Jane Smith", Email: "jane@company.com"},
...
`
	...
	expected := &Commit{
		...
		Assignee: assignee.Assignee{Name: "CI Bot", Email: "ci@example.com"},
